...
export const store = reactive({
    ...
    experiences: [
        ...
        },
        {
            ...
            description: "Durante la mia esperienza in Validus Srl ho collaborato allo sviluppo di un gestionale aziendale simulato per un’impresa informatica (caso di studio) specializzata nella vendita di computer e accessori. Il progetto mi ha permesso di mettere in pratica diverse competenze nello sviluppo software, sia lato applicativo che infrastrutturale:" +
                "<div class=\"p-2\">" +
                "<ul class=\"ms-3\">" +
                "<li><strong>Front-End (ExtJS):</strong> <br> <small>Progettazione e sviluppo di interfacce web interattive tramite il framework Sencha ExtJS;</small></li>" +
                "<li><strong>Back-End (CakePHP):</strong> <br> <small>Implementazione della logica applicativa server-side attraverso il framework CakePHP;</small></li>" +
                "<li><strong>Database (PostgreSQL):</strong> <br> <small>Gestione di database relazionali, con particolare attenzione a query, ottimizzazione e modellazione dei dati;</small></li>" +
                "<li><strong>Linux & Nginx:</strong><br> <small>Configurazione e gestione dell’ambiente server, ottimizzando il sistema operativo Linux Fedora e il web server NGINX;</small></li>" +
                "<li><strong>SOAP & SoapUI:</strong> <br> <small> Implementazione e collaudo di servizi SOAP, utilizzando SoapUI per il testing e la validazione delle integrazioni;</small></li>" +
                "<li><strong>Web Scraping:</strong> <br> <small> Realizzazione di script in PHP per l’estrazione automatizzata di dati da siti web;</small></li>" +
                "<li><strong>WebSockets:</strong> <br> <small> Sviluppo di meccanismi di comunicazione in tempo reale tra client e server;</small></li>" +
                "</ul>" +
                "</div>"
        },
        {
    ...
    projects: [
        {
            id: 1,
            title: "TravelDiary",
            image: "/img/Traveldiary.png",
            description: "Progetto di un diario di viaggio personale per chi ama viaggiare che consente di salvare e organizzare i propri viaggi, tappe ed esperienze personali. L’app integra un sistema di intelligenza artificiale basato su Google Gemini, con cui l’utente può interagire tramite chat per ricevere suggerimenti di viaggio personalizzati. Analizzando le preferenze e le esperienze passate, l’AI propone nuove destinazioni in linea con gli interessi dell’utente.",
            skills: ["REACT", "TAILWIND", "FASTAPI", "MySQL"],
            type: "FULL-STACK",
            link_github: "https://github.com/albertostizzoli/fastapi-react-travelapp"
        },
        {
            id: 2,
            title: "Weather App",
