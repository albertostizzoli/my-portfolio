    ...
    projects: [
        {
            ...
            description: "Replica della famosa piattaforma di streaming musicale Spotify",
            skills: ["HTML", "CSS"],
            type: "FRONT-END",
...

        {
            ...
            description: "Boolflix è un semplice motore di ricerca di Film e serie TV, vagamente ispirato a Netflix. La Web App mostra in home page le copertine dei film e serie TV più popolari e al passaggio del mouse su di essa mostra i rispettivi dati: quest'ultimi sono ottenuti tramite chiamate AJAX al server di The Movie DB. L'utente è in grado di cercare i titoli che più interessando inserindo la parole chiave nell'apposita barra di ricerca.",
            skills: ["VueJS", "SASS"],
            type: "FRONT-END",
...

        {
            ...
            description: "Replica della parte grafica del sito EduPrime svolta come Progetto MidTerm durante il corso di Boolean",
            skills: ["VueJS", "SASS"],
            type: "FRONT-END",
